...
const clients: Array<{
    ...
    },
    {
        ...
        // Sin login interactivo: las tablets se autentican contra la API de sync,
        // no redirigen aqui. Por eso no hay callbacks ni dominios.
        allowedCallbackUrls: [],
        allowedDomains: [],
        // apikey:verify  -> valida la credencial de cada tablet (§2.4 del plan de la APK)
        // session:verify -> valida cookies cuando el alta la hace un admin desde la web
        // jwt:sign/verify-> emite y verifica JWT de servicio hacia la API en Go
